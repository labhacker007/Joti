      ...
      <Space direction="vertical" size="large" style={{ width: '100%' }}>
        ...
        >
          <Alert
            ...
            description="When you create a custom report, Orion will automatically generate and download a professionally formatted PDF document with executive summaries, IOCs, TTPs, and recommendations."
            type="info"
            showIcon
            icon={<FilePdfOutlined />}
