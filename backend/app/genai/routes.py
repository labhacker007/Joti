...
ORION_HELP_DOCS = {
    "getting-started": """# Getting Started with Orion
...
def find_best_help_match(question: str) -> str:
    ...
    return ORION_HELP_DOCS.get(best_match, ORION_HELP_DOCS["getting-started"])
...
async def get_help(
    ...
    try:
        ...
        prompt = f"""You are Orion's AI assistant. Help the user with their question about the platform.
