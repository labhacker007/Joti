...
def article_to_response(article: Article, user_id: Optional[int] = None, db: Optional[Session] = None, include_intel: bool = False) -> ArticleResponse:
    ...
    response_data = {
        ...
        "ingested_at": getattr(article, 'ingested_at', None) or article.created_at,  # When Jyoti ingested
...
async def export_article_pdf(
    ...
    company_name = branding.get('company_name', 'Jyoti')
    ...
    def add_header_footer(canvas, doc):
        ...
        canvas.drawRightString(540, 18, "JYOTI PLATFORM")
...
<body>
    ...
    html += '''
        <div class="footer">
            <p>Generated by Jyoti News Feed Platform</p>
        </div>
    </div>
</body>
</html>'''
