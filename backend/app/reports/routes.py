...
def export_report_pdf(
    ...
    company_name = branding.get('company_name', 'Orion Security')
    ...
    report_footer = branding.get('report_footer', 'Generated by Orion Threat Intelligence Platform')
    ...
    disclaimer_box = Table(
        [[Paragraph(
            f"<b>DISCLAIMER:</b> This report was generated by {company_name} using the Orion Threat Intelligence Platform. "
    ...
    filename = f"Orion_Report_{safe_title}_{date_str}.pdf"
...
<body>
  ...
  <footer>
    ...
    <div class="footer-text">{company_name} • Threat Intelligence Report • Generated by Orion</div>
  </footer>
</body>
</html>'''
